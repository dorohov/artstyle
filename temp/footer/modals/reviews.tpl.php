			...
			<div class="modal-content _rms__content">
				<div class="modal-body _rms__body" >
					...
					<div class="modal-block _rms__block">		
						<h3 class="modal-title _rms__title">Написать отзыв</h3>
						
						<form action="/formsave/" method="POST" class="form-site contacts-form "> 
							<div class="form-site__note ">Немножко текста поясняющего зачем нужно писать отзыв.</div>
							<div class="row _rms__row">
								...
								<div class="cols _rms__cols">
									<div class="_rms__input icon icon-tel">
										<textarea id="f[note]" name="note"  class="_frs__form-control form-control validate[required]" placeholder="Ваш отзыв"></textarea>
									</div>	
								</div>
								<div class="cols _rms__cols">
									<div class="_rms__input _rms__btn">
										<button type="submit" class="btn-site btn-blue btn-submit finalFormModal ">Оставить отзыв</button>
									</div>	
								</div>
							</div>
						</form> 
